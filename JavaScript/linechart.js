...
function updateLastYearOptions() {
  ...
  // Generate options for years within a 10-year range
  for (var year = parseInt(selectedInitialYear); year <= parseInt(selectedInitialYear) + 10; year++) {
    var option = document.createElement("option");
    option.value = year;
    option.text = year;
